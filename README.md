...
You can run a quick start exmaple in [~/ResFF/scripts/exmaple/](https://github.com/Ameki0/ResFF/blob/main/scripts/exmaple/) using preprocessed torsion and s66x8 datasets.
