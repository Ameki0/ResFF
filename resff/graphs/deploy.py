...
OPENMM_NONBONDED_SIGMA_UNIT = OPENMM_LENGTH_UNIT
OPENMM_NONBONDED_EPSILON_UNIT = OPENMM_ENERGY_UNIT
# =============================================================================
# MODULE FUNCTIONS
# =============================================================================
        ...
        if "HarmonicBondForce" in name:
            ...
            for idx in range(force.getNumBonds()):
                ...
                _k = Quantity(  # bond force constant:
                    ...
                    _k,
                    resff.units.FORCE_CONSTANT_UNIT,
        ...
        if "HarmonicAngleForce" in name:
            ...
            for idx in range(force.getNumAngles()):
                ...
                _k = Quantity(  # force constant
                    ...
                    # we insert a coefficient of 2.0
                    _k,
                    resff.units.ANGLE_FORCE_CONSTANT_UNIT,
