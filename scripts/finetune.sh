...
n_max_confs=50 # number of conformations, actual batch size = number of conformations × number of molecules
...
input_prefix="your/dataset/path" # training data path
datasets="your/dataset/name" # training dataset
output_prefix="your/output/path" # output path
...
#do
python finetune.py --epochs $epochs --batch_size $batch_size --layer_1 $layer_1 --layer_2 $layer_2 --units $units --activation $activation --config_1 "$config_1" --config_2 "$config_2" --janossy_config "$janossy_config" --learning_rate $learning_rate --input_prefix $input_prefix --datasets "$datasets" --output_prefix $output_prefix --n_max_confs $n_max_confs --force_weight $force_weight --residual_weight $residual_weight #--stage $stage 
#done
