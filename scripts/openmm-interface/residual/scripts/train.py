...
def get_argparse():
    ...
    parser.add_argument('--max-noise-scale', default=0., type=float, help='max scale')
    parser.add_argument('--min-noise-scale', default=0., type=float, help='min scale')    
    ...
    parser.add_argument('--element_wise_noise', type=bool, default=False,help='If the task uses element-wise noise.')
    parser.add_argument('--deriv_as_denoise_target', type=bool, default=False,help='If the task uses derivative as denoising objective.')
    parser.add_argument('--filter_elem', type=bool, default=False,help='If the task filter dataset based on element list.')
    ...
    parser.add_argument('--layernorm-in-att', type=bool, default=False, help='Whether to apply layer norm in attentiom.')
