...
vl_datasets="demo" # validation dataset
...
#do
python ~/ResFF/val.py --epochs $epochs --batch_size $batch_size --layer_1 $layer_1 --layer_2 $layer_2 --units $units --activation $activation --config_1 "$config_1" --config_2 "$config_2" --janossy_config "$janossy_config" --learning_rate $learning_rate \
